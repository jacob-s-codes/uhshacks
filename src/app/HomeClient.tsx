      ...
      <div className='pt-36 bg-white sm:px-6 lg:px-8 px-4' id="theteam">
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-2 gap-y-12 gap-x-8 place-items-center items-start'>
            <Person
              name="Ella Shaul"
              bio="Hi, I'm Ella! I'm super excited to lead with UHS Hacks 2027! I like to hang out with friends, listen to music, and anything STEM related. You can reach me at: elmshaul@gmail.com"
